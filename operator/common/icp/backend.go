// Package icp provides a client for the "client" canister.
...
type CertifiedStatus struct {
	Certificate         *[]uint8   `ic:"certificate,omitempty" json:"certificate,omitempty"`
	Data                string     `ic:"data" json:"data"`
	PendingSecretReqs   []Secret   `ic:"pending_secret_reqs" json:"pending_secret_reqs"`
	Secrets             []Secret   `ic:"secrets" json:"secrets"`
	Consumers           []Consumer `ic:"consumers" json:"consumers"`
	PendingConsumerReqs []Consumer `ic:"pending_consumer_reqs" json:"pending_consumer_reqs"`
}
...
type Consumer struct {
	...
	SecretKubeId    string `ic:"secret_kube_id" json:"secret_kube_id"`
	UpdateTimestamp string `ic:"update_timestamp" json:"update_timestamp"`
	PermissionType  uint8  `ic:"permission_type" json:"permission_type"`
	KubeId          string `ic:"kube_id" json:"kube_id"`
}

type InitArgs struct {
	Admin principal.Principal `ic:"admin" json:"admin"`
}
